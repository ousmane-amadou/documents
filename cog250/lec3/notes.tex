...
\textbf{Related Topics: } Substance Theory, Aristotle's Categories, Natural Kinds}

\textbf{Key Idea:  } Everytime you hear "All x are y" be very critical of it.}

You can treat everything in your environment as an instance of a type.

Naive model - We look at things and decide based off similarity whether
things belong in the same category. These things belong together. Rely on your
perception and judgement to form categories.

However, things have an infinte amount of feature complexity that can form categories
in our world.

Lance Rips - double Dissociation
...
Main Ideas:
- Geometrical notion for categorization
