...
\lecture{2}{Categorization I (Resemblance Theory)}{Anderson Todd}{Ousmane Amadou}
%\footnotetext{These notes are partially based on those of Nigel Mansell.}

\section{Introduction to Categorization}
To begin a conversation about categorization we begin by discussing a naive theory
of categorization. It is reasonable to think that we cateogrize a stimulus into
a category based off how similar that stimulus is to the members of said category.
This "one of these things does not belong together" model of cateogrization implies
that we rely on perception and judgement to form categories.

Although this naive theory may hold up at first glance, there are a number of
problems with it. For one, if we are treating similarity as a question of partial identity of terms, then things have an
